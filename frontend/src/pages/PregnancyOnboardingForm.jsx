...
const PregnancyOnboardingForm = ({ onComplete }) => {
  ...
  const handleCompleteSetup = async () => {
    ...
    console.log(
      "Onboarding data submitted and saved to localStorage:",
      formData
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary-50 to-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center section-padding">
        <div className="container-width max-w-md w-[52.5%] mt-8">
                    ...
                    <div
                      ...
                      ${
                        currentStep > index + 1
                          ...
                          : currentStep === index + 1
                          ? "border-pink-500 border-[0.1rem] text-pink-500"
                  ...
                  {index < totalSteps - 1 && (
                    <div
                      className={`flex-1 h-0.5 mx-2 ${
                        currentStep > index + 1 ? "bg-green-500" : "bg-pink-300"
                      }`}
                    />
                  )}
                </React.Fragment>
            ...
            <form onSubmit={handleSubmit} className="px-6 py-6">
              ...
              {currentStep === 1 && (
                <div className="space-y-4">
                  ...
                  <div className="border-t pt-4 mt-4 w-full grid grid-cols-2 gap-4">
                    <div>
                      <label
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center mt-4">
                    ...
                    <p className="text-sm text-gray-500">
                      We'll use this information to personalize your pregnancy
                      journey and provide week-by-week guidance.
                    </p>
                  </div>
                </div>
              )}
                    ...
                    <div className="flex">
                      <div className="ml-3">
                        <p className="text-sm text-blue-700">
                          Your information is private and secure. We use it only
                          to personalize your pregnancy experience.
                        </p>
                      </div>
                    </div>
                  </div>
