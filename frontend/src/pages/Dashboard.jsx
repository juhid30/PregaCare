...
const Dashboard = () => {
  ...
  const [weekOfPregnancy, setWeekOfPregnancy] = useState(() => {
    const data = localStorage.getItem("pregnancyProfileData"); // Make sure the key is quoted
    try {
      const parsed = JSON.parse(data);
      return parsed?.pregnancyWeek || 0;
    } catch {
      return 0;
    }
  });
  ...
  const babySizeData = {
    4: {
      size: "Poppy Seed",
      message: "Your little one is just getting started!",
    },
    8: { size: "Raspberry", message: "Your baby is growing rapidly!" },
    12: {
      size: "Lime",
      message: "Congratulations! Your baby is now the size of a lime.",
    },
    16: {
      size: "Avocado",
      message: "Amazing! Your baby is now as big as an avocado.",
    },
    20: {
      size: "Banana",
      message: "Halfway there! Your baby is the size of a banana!",
    },
    24: {
      size: "Corn on the Cob",
      message: "Your baby continues to grow beautifully!",
    },
    28: {
      size: "Eggplant",
      message: "Your baby is getting bigger and stronger!",
    },
    32: {
      size: "Pineapple",
      message: "Not long to go now! Your baby is thriving!",
    },
    36: {
      size: "Honeydew Melon",
      message: "Almost there! Your baby is almost ready to meet you!",
    },
    40: {
      size: "Watermelon",
      message:
        "Any day now! Your baby is fully developed and ready for the world!",
    },
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="text-center mb-10 mt-[5.5rem]">
          <h2 className="!text-5xl font-bold heading-primary text-gray-900">
            {getGreeting()}
          </h2>
          <p className="mt-2 text-lg text-gray-600">
            Track your journey and get personalized updates for week{" "}
            {weekOfPregnancy}
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 mt-8">
                  ...
                  <div className="mb-4 bg-white rounded-full p-6 shadow-md">
                    ...
                    <div className="w-32 h-32 flex items-center justify-center">
                      ...
                      <div className="text-6xl">
                        {getSizeEmoji(babySize.size)}
                      </div>
                    </div>
                  </div>
                  <h4 className="text-2xl font-bold text-pink-500 mb-2">
                    Size of{" "}
                    {babySize.size === "Avocado" || babySize.size === "Eggplant"
                      ? "an"
                      : "a"}{" "}
                    {babySize.size}
                  </h4>
          ...
          <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="p-6 max-w-2xl mx-auto flex flex-col justify-between h-full">
                <div>
                  {" "}
                  ...
                  {reminders.length === 0 && (
                    <p className="text-gray-500">
                      No reminders yet. Start by adding one!
                    </p>
                  )}
                </div>
                ...
                <ul className="mt-4 space-y-3">
                  {reminders.map((reminder, index) => (
                    <li key={index} className="border-b pb-3 flex items-center">
                      <input
                        type="checkbox"
                        checked={reminder.done}
                        onChange={() => toggleReminderStatus(index)}
                        className="mr-3 w-4 h-4 accent-pink-500"
                      />
                ...
                <button
                  className="mt-6 w-full px-4 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600"
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="p-6">
                ...
                {weekOfPregnancy <= 13 ? (
                  <div className="bg-pink-50 rounded-lg p-4 mb-3">
                    <p className="text-gray-800">
                      First trimester: Focus on folic acid intake with leafy
                  ...
                  <div className="bg-pink-50 rounded-lg p-4 mb-3">
                    <p className="text-gray-800">
                      Second trimester: Try to include more leafy greens in your
                      diet this week to boost your iron intake.
                    </p>
                  </div>
                ) : (
                  <div className="bg-pink-50 rounded-lg p-4 mb-3">
                    <p className="text-gray-800">
                      Third trimester: Increase calcium intake with dairy,
                      beans, and fortified plant milks.
                    </p>
                  </div>
                )}
                ...
                <button
                  onClick={() => setIsMealPlannerModalOpen(true)}
                  className="mt-2 w-full px-4 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600"
                >
                  View Meal Planner
                </button>{" "}
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-b pb-3">
                    <p className="font-medium">
                      New poll: Baby names trending in 2025
                    </p>
                    <p className="text-sm text-gray-600">
                      Yesterday • 42 votes
                    </p>
                  ...
                  <div>
                    <p className="font-medium">
                      Weekly Live Q&A with Dr. Hansen
                    </p>
